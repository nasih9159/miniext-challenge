...
import SignWithEmail from '@/components/ui/SignWithEmail';
                ...
                <div className="max-w-xl w-full rounded overflow-hidden shadow-lg py-2 px-4">
                    <div className="flex gap-4 mb-5 flex-col">
                        ...
                        <div className="mt-2 grid grid-cols-1 gap-3">
                            <LoginWithGoogleButton type="sign-in" />
                        </div>
                        <div className="mt-2 grid grid-cols-1 gap-3">
                            <LoginWithPhoneButton mode="signin" />
                        </div>
                        <div className="mt-6">
                    ...
                    <Modal show={showRegistration} setShow={setshowRegistration}>
                        <SignWithEmail type="sign-up" />
                    </Modal>
                </div>
            </div>
            <ToastBox />
